/**
 * MarketLens AI — Analysis Logic & Mathematics Harmonizer
 *
...
export function harmonizeAnalysis(
  analysis: AIProductAnalysis,
  context?: Partial<UniversalListingContext>
): AIProductAnalysis {
  ...
  const itemAge = year ? currentYear - year : 0;
